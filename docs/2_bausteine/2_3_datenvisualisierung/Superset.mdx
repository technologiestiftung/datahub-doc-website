...
Eine Fachabteilung erstellt monatlich ein Dashboard in Superset, das zeigt, wie sich Fördermittel über Bezirke verteilen: Statt Excel-Tabellen zu verschicken, werden die Daten filterbar und interaktiv visualisiert und um Erklärtexte ergänzt, und ein Link zum Dashboard geteilt – aktuell, interaktiv und leicht verständlich.  

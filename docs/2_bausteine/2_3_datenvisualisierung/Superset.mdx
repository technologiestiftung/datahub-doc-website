...
- [Digitale Bezirksregionenprofile:](/docs/anwendungen/landesgleichstellung) Dashboards zur Visualisierung Indikatoren auf Bezirksebene
- [Datenbasierte Bibliothekssteuerung:](/docs/anwendungen/datenbasierte_bibliothek) Monitoring von Ausleihen und Angeboten zur Steuerung der Makulatur
- [Digitales Landesgleichstellungsmonitoring:](/docs/anwendungen/landesgleichstellung) Visualisierung von Kennzahlen zur Gleichstellung in Berlin

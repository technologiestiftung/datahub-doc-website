  ...
  <div className="flex flex-col xl:flex-row items-center gap-8 xl:gap-10 xl:pl-16 pt-16">
    <div>
      ...
      <p className="text-lg">
        ...
        Sie basiert auf <strong>Civitas CORE</strong>, einer offenen, modularen Architektur, 
...
Schematische Darstellung der Komponenten und ihrer Verbindungen im Data Hub Berlin
</figcaption>

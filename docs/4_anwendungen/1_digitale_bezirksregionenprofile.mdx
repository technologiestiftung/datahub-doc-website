...
Der derzeitige Prozess rund um die Erstellung und Veröffentlichung der Bezirkregionenprofile ist für viele Beteiligte nicht mehr zufriedenstellen. Grund dafür sind:

- **Hoher manueller Aufwand:** Die Erstellung der BZRP ist sehr zeitaufwendig, da viele Prozesse manuell erfolgen, inklusive Datenexporten, analoger Arbeitsschritte und Medienbrüchen. Augrund mangelnder Ressourcen und weil die BZRP regelmäßig neu erstellt werden müssen, bleibt in vielen Bezirken so keine Zeit für die eigentliche tiefergehende Analyse der Daten und die Erstellung von Maßnahmenbeschreibungen über die Kurzprofile hinaus
  ...
  <>
    <div className="tabs__content">
      ...
      <ul className="ml-4 list-disc">
        ...
        <li>Organisationseinheit Sozialraumorientierte Planungskoordination (OESPK), inkl. bezirklicher Datenkoordinator:innen</li>
...
- Parallel werden die Daten in die relationelle Datenbank des Data Hub importiert, inklusive bezirksspezifischer Daten, die unterschiedlich formatiert vorliegen.  
...
- Erstellung von Personas für Gelegenheits- und Poweruser:innen des Dashboards, um Bedürfnisse und Kompetenzen zu verstehen  
...
- Es ist wichtig, eine Balance zwischen schnellem Prototyping, einem tiefgründigen Verständnis der Prozesse und dem Bedürfnis, komplexe Verwaltungsabläufe zu optimieren und zu beschleunigen, zu finden. An den BZRP zeigt sich, ein bestehender Prozess und ein analoges Produkt lassen sich nicht 1 zu 1 ins Digitale überführen. Stattdessen muss im Rahmen einer möglichst sinnvollen Verwaltungsmoderisierung Stück für Stück hinterfragt und neusortiert werden.
